...
from exceptions import ErroDeConexao, ErroAoCriarTabelaCliente, ErroAoInserirCliente, ErroAoAtualizarCliente
...
def atualizar_registro(conn, **kwargs):
    ...
    try:
        ...
        raise ErroAoAtualizarCliente ("Erro ao atualizar cliente! {erro}")
